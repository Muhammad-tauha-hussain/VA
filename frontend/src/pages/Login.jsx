...
export default function Login() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-[url('https://images.pexels.com/photos/8294621/pexels-photo-8294621.jpeg')] bg-left bg-cover">
          ...
          <div className="backdrop-blur-xs bg-white/10 rounded-3xl shadow-2xl border border-white/20 p-8">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-white mb-2">
                Login to <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-cyan-300">VA</span> Assistant
              </h1>
            </div>
